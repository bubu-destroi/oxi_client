  ...
  return (
    <>
      <div className="flex flex-col items-center justify-center min-h-screen pt-20 p-4">
        <h2 className="text-xl sm:text-l font-bold pt-2 mb-4 text-center md:max-w-lg ">
          Create an account to sign up for workshops and tell us what you want to learn about!
        </h2>
        <h5 className="text-sm sm:text-base mb-4 flex flex-col items-center justify-center">
          Do you already own an account? <Link to="/login" className="text-red-500 hover:underline">Log in here!</Link>
        </h5>
        <form
        ...
        >
          <p className="text-sm mb-4 text-center">
            We need your parents/caretaker information! If you are an adult, input your own information.
          </p>
          <label htmlFor="parent-name" className="block text-sm font-medium text-gray-700">Their name</label>
          <input
            type="text"
            name="parent-name"
            id="parent-name"
          ...
          />
          <label htmlFor="address" className="block text-sm font-medium text-gray-700 mt-4">Their address</label>
          <input
            type="text"
            name="address"
            id="address"
          ...
          />
          <label htmlFor="phone-number" className="block text-sm font-medium text-gray-700 mt-4">Their telephone number</label>
          ...
          <label htmlFor="id_card_picture" className="block text-sm font-medium text-gray-700 mt-4">Upload their ID card picture</label>
          <input
            type="file"
          ...
          />
          <label htmlFor="email" className="block text-sm font-medium text-gray-700 mt-4">Their email</label>
          <input
            type="email"
            name="email"
            id="email"
          ...
          <label htmlFor="learner_username" className="block text-sm font-medium text-gray-700 mt-4">Create a username for your profile</label>
          <input
            type="text"
          ...
          />
          <label htmlFor="date_of_birth" className="block text-sm font-medium text-gray-700 mt-4">What is your date of birth?</label>
          <input
            type="date"
            name="date_of_birth"
            id="date_of_birth"
